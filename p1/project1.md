...
1. Get the following files together:
    ...
    2. p1.html
    3. Any images used
    3. README.txt, which mentions any online sources you used to help with the project, as well as any notes about your programs (i.e. if you couldn’t get a particular part of the project to work). Also, please include a rough estimate of how many hours it took you.
